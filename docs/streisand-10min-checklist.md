...
3. Открой `ip.ru`.
   Ожидание: `DIRECT/RU`.
   Если видишь NL/proxy, это confirmed mismatch.
4. Открой `gosuslugi.ru`.
   Ожидание: `DIRECT`.
5. Открой `nalog.ru`.
   Ожидание: `DIRECT`.
...
Если direct-кейсы уходят в proxy или в иностранный IP, split в Streisand на этом устройстве считать ненадёжным.

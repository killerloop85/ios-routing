...
- (опционально) `streisand/routing-profile-split.streisand-uri.txt` — import-ready `streisand://` URI для split-профиля.
...
- выпускает import-ready `streisand://...` URI в `.streisand-uri.txt`;
